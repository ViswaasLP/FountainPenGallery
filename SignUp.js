...
function checkInputs() {
  ...
  if (passwordValue === "") {
    ...
    errorcase(
      password,
      "ERROR: Password does not have lowercase letters",
      "nolow"
    );
    passerror.setAttribute("aria-hidden", "false");
    passpass = 0;
    ...
    errorcase(
      password,
      "ERROR: Password does not have uppercase letters",
      "noup"
    );
    passerror.setAttribute("aria-hidden", "false");
    passpass = 0;
...
form.addEventListener("submit", (e) => {
  ...
  if (
    ...
    alert(
      "Sign Up successful! However, please use 'level' and 'Access123' when logging in."
    );
  }
  checkInputs();
});
